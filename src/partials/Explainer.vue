    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <div class="flex justify-center pb-12 md:pb-16" data-aos="fade-up">
          ...
          <Modal id="video-modal" ariaLabel="modal-headline" :modalOpen="videoModalOpen" @close-modal="videoModalOpen = false">
            <video ref="video" className="w-full aspect-video" width="1920" height="1080" loop controls>
              <source src="../videos/MLH_Hackathon_Intro.mp4" type="video/mp4" />
        ...
        <div class="relative pb-12">
          ...
          <!-- Line -->
          <div class="hidden lg:block absolute top-4 left-32 right-32 mt-px h-0.5 bg-gray-200 -z-10" aria-hidden="true"></div>
        ...
        <!-- CTA -->
        <div class="text-center">
          <a class="btn-sm inline-flex items-center text-white bg-gray-900 hover:bg-gray-800 group" href="https://forms.gle/wPM6w21ww5dQLgg38" target="_blank">
            REGISTER NOW
