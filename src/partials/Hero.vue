<template>
  <section class="relative overflow-hidden">
    <!-- Bg -->
    <div class="absolute inset-0 bg-blue-600 pointer-events-none -z-10" aria-hidden="true"></div>

    <!-- Illustration -->
    <!-- Illustration -->
    <VImg cover height="450" :src="hero">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-28 pb-16 md:pt-40 md:pb-20">
        ...
        <aos-vue animation="fade-up">
          <h1 class="h1 font-cabinet-grotesk text-white mb-2">BCHACKS 2024</h1>
          <p class="text-lg md:text-xl text-white text-opacity-120 font-bold mb-8">
            2024 April 12 - 14 | Bellevue College N Building</p>
        </aos-vue>
          <aos-vue animation="fade-up" delay="200">
...
<script setup>
import hero from "../../public/hero-background-pastel.svg";
</script>
